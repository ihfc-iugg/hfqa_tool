...
setup(
    ...
    author="Saman Firdaus Chishti": "Developer"; "Elif Balkan-Pazvantoğlu", "Ben Norden", "Florian Neumann", "Samah Elbarbary", "Eskil Salis Gross", "Sven Fuchs": "Checking code for applicability to the dataset"
